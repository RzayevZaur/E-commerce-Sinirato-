...
class blogp(models.Model):
    ...
    imdb =models.DecimalField(max_digits=5,decimal_places=2,verbose_name='blog py')
    is_adviced=models.BooleanField(default=True,verbose_name='do you like  this blog')
    genre=models.IntegerField(choices=GENRE,default=0,verbose_name='Genre of you blog')
